...
x_xor_k_4 = x_xor_k * 4
s_x_k = im_data(out, 0)
s_x_k_py = table_value(x_xor_k)

all_im_str = ["k", "x", "x_xor_k", "x_xor_k_4", "s_x_k"
              ]
all_im = [k, x, x_xor_k, x_xor_k_4, s_x_k
          ]
...
plt.legend(["k", "x", "x + k", "(x+k) * 4", "sbox(x + k)"], loc="upper left")
